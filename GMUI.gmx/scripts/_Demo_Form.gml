...
GMUI_SetKeyNavigation(GMUIDirection.Vertical,vk_up,vk_down,vk_left,vk_right,true);
...
GMUI_CreateGroup(1,      2,2,   GMUIAnchor.TopLeft);
...
// group border
GMUI_CreateGroup(99, 20, 2, GMUIAnchor.TopRight);
GMUI_GroupSetStyle(99, c_black, .2, c_black, .3, 0);
GMUI_GroupSetSize(99,20,33);

with (GMUI_Add("Right","label",0,0,1,1,GMUIAnchor.TopRight)) {
...
with (GMUI_Add("MidSlider", "button",           1,4,  2,2,    GMUIAnchor.TopLeft)) {
    GMUI_ControlAddToGroup(2);
...
with (GMUI_Add("SnapSlider", "button",          1,6,  3,2,    GMUIAnchor.TopLeft)) {
    GMUI_ControlAddToGroup(2);
...
with (GMUI_Add("SliderVal", "label",            16,6,   2,2,    GMUIAnchor.TopLeft)) {
    GMUI_ControlAddToGroup(2);
...
with (GMUI_Add("SliderV", "slider",              6,9,  4,8,   GMUIAnchor.TopLeft)) {
    GMUI_ControlAddToGroup(2);
    GMUI_ControlSetSliderSettings(13,10,34,true,true,true,GMUIDirection.Vertical);
    GMUI_ControlSetSliderStyle(2,2,c_dkgray,0.6,c_teal,0.9,c_dkgray,0.4,c_aqua,1,c_gray,0.8);
    GMUI_ControlSetSliderSize(16, 20, 1, 12, 10, 8, 6, 8);
    GMUI_ControlSetInitValue(20);
}
...
with (GMUI_Add("Test4", "intpicker",            1,10,    10,2,   GMUIAnchor.TopLeft)) {
    ...
    with (GMUI_ControlAddTooltip("-20 to 20.",GMUIAnchor.TopLeft,6,2,12,4,-1,-1)) {
...
with (GMUI_Add("Toggle2", "toggle",              3,9,   3,2,    GMUIAnchor.TopLeft)) {
    GMUI_ControlSetToggleSettings(1, c_lime, c_gray, global.GMUISlideRoundRect, $808080, $505050, room_speed/4, GMUIDirection.Horizontal, 0);
    GMUI_ControlAddToGroup(4);
}

with (GMUI_Add("Toggle3", "toggle",              3,12,   3,2,    GMUIAnchor.TopLeft)) {
    GMUI_ControlSetToggleSettings(1, c_lime, c_gray, global.GMUISlideRect, $808080, $505050, room_speed/4, GMUIDirection.Horizontal, 0);
    GMUI_ControlAddToGroup(4);
    GMUI_ControlSetInitValue(true);
}

with (GMUI_Add("Toggle4", "toggle",              3,15,   3,2,    GMUIAnchor.TopLeft)) {
    GMUI_ControlSetToggleSettings(1, c_lime, c_gray, global.GMUISlideLine, $808080, $505050, room_speed/4, GMUIDirection.Horizontal, 0);
    GMUI_ControlAddToGroup(4);
}
...
with (GMUI_Add("CheckBox", "checkbox",          3,20,   1,1,    GMUIAnchor.TopLeft)) {
    ...
    with (GMUI_ControlAddTooltip("Checkbox!",GMUIAnchor.Bottom,6,2,12,4,-1,-1)) {
...
GMUI_CreateGroup(9,      20,2,    GMUIAnchor.TopRight);
...
GMUI_CreateGroup(10,      20,2,    GMUIAnchor.TopRight);
...
with (GMUI_Add("ExitButton", "textbutton",      0,0,    1,1,     GMUIAnchor.TopRight)) {
...
with (GMUI_Add("CloseButton", "textbutton",   4,1,   4,1,    GMUIAnchor.TopRight)) {
    GMUI_ControlSetButtonAction(_PopupClose_Button);
    GMUI_ControlSetButton("Close",-1,-1,-1);
    GMUI_ControlAddToMenu("Test Menu");
}

with (GMUI_Add("OpenButton", "textbutton",   -3,8,   8,1,    GMUIAnchor.Top)) {
    GMUI_ControlSetButtonAction(_PopupMenu2_Button);
    GMUI_ControlSetButton("Open Another",-1,-1,-1);
    GMUI_ControlAddToMenu("Test Menu");
}

with (GMUI_Add("Toggle5", "toggle",              2,4,   3,2,    GMUIAnchor.BottomLeft)) {
    GMUI_ControlSetToggleSettings(1, c_lime, c_gray, GMUISlideShape.FullRoundRectangle, $808080, $505050, room_speed/4, GMUIDirection.Horizontal, 0);
    GMUI_ControlAddToMenu("Test Menu");
}


// Test Menu 2
menuID = GMUI_CreateMenu("Test Menu 2",   -6,8,   18,24,   GMUIAnchor.Top);
...
with (GMUI_Add("CloseButton2", "textbutton",   4,1,   4,1,    GMUIAnchor.TopRight)) {
    GMUI_ControlSetButtonAction(_PopupClose_Button);
    GMUI_ControlSetButton("Close",-1,-1,-1);
    GMUI_ControlAddToMenu("Test Menu 2");
}

with (GMUI_Add("PopupTestButton","textbutton",  -3,8,   8,1,    GMUIAnchor.Top)) {
    GMUI_ControlSetButtonAction(_Popup_Button);
    GMUI_ControlSetButton("Try Popup",-1,-1,-1);
    GMUI_ControlAddToMenu("Test Menu 2");
}

with (GMUI_Add("ResponseLabel", "label", -8, 10, 16, 2, GMUIAnchor.Top)) {
